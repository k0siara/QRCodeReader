...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultBorderColorBlur = getResources().getColor(R.color.viewfinder_border_blur);
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(R.integer.viewfinder_border_width);
    private final int mDefaultBorderStrokeBlurWidth = getResources().getInteger(R.integer.viewfinder_border_blur_width);
    private final int mDefaultBorderLineLength = getResources().getInteger(R.integer.viewfinder_border_length);

    protected Paint mLaserPaint;
    protected Paint mFinderMaskPaint;
    protected Paint mBorderPaint;
    protected Paint mBorderPaintBlur;
    ...
    private void init() {
        ...
        mBorderPaintBlur = new Paint();
        mBorderPaintBlur.set(mBorderPaint);
        mBorderPaintBlur.setColor(mDefaultBorderColorBlur);
        mBorderPaintBlur.setStrokeWidth(mDefaultBorderStrokeBlurWidth);
        mBorderPaintBlur.setMaskFilter(new BlurMaskFilter(15, BlurMaskFilter.Blur.NORMAL));
    ...
    public void drawViewFinderBorder(Canvas canvas) {
        ...
        canvas.drawPath(path, mBorderPaintBlur);
        canvas.drawPath(path, mBorderPaint);

        // Right
        path.moveTo(framingRect.right, framingRect.top);
        path.lineTo(framingRect.right, framingRect.bottom);
        canvas.drawPath(path, mBorderPaintBlur);
        canvas.drawPath(path, mBorderPaint);

        // Bottom
        path.moveTo(framingRect.right, framingRect.bottom);
        path.lineTo(framingRect.left, framingRect.bottom);
        canvas.drawPath(path, mBorderPaintBlur);
        canvas.drawPath(path, mBorderPaint);

        // Left
        path.moveTo(framingRect.left, framingRect.bottom);
        path.lineTo(framingRect.left, framingRect.top);
        canvas.drawPath(path, mBorderPaintBlur);
        canvas.drawPath(path, mBorderPaint);


        /* Original corner draw
